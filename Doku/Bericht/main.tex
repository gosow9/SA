...
\input{0-abstract/0-abstract.tex}
\tableofcontents

\mainmatter

\input{00-abbreviations/00-abbreviations.tex}
\input{1-intro/1-intro.tex}
\input{2-theory/2-theory.tex}
\input{3-evaluation/3-evaluation.tex}
\input{4-development/4-development.tex}
\input{5-results/5-results.tex}
\input{6-summary/6-summary.tex}
...
\input{statment_of_plagiarism/statement_of_plagiarism.tex}
