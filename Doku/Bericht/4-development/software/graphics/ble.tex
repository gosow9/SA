...
\begin{tikzpicture}
	...
	\node[below, blue!60!black] at (0,1.6) {Receiver};
	\node[below, blue!60!black] at (5,1.6) {Transmitter};

	\node[rotate=90, below, blue!60!black] at (-2.1,0) {disconnected};
	\node[rotate=90, below, blue!60!black] at (-2.1,0-\sh) {connected};

	%disconnected
	\fill[white, draw=black] (0,0) ellipse (1.3 and 0.7);
	\node at (0,0) {Peripheral};
	...
	\node at (2.5,1.3) {\footnotesize advertise};
	\node at (2.5,-1.3) {\footnotesize connect};
		
	%connected	
	\fill[white, draw=black] (0,0-\sh) ellipse (1.3 and 0.7);
	\node at (0,0.2-\sh) {Peripheral};
	\node at (0,-0.2-\sh) {(Server)};
	\fill[white, draw=black] (5,0-\sh) ellipse (1.3 and 0.7);
	\node at (5,0.2-\sh) {Central};
	\node at (5,-0.2-\sh) {(Client)};
		
	\draw [arrow, bend right=20] (4.3,0.6-\sh) to (0.7,0.6-\sh);
	\draw [arrow, bend right=20] (0.7,-0.6-\sh) to (4.3,-0.6-\sh);
	
	\node at (2.5,1.3-\sh) {\footnotesize read/write};
	\node at (2.5,-1.3-\sh) {\footnotesize notify};
