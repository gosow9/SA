...
The result of the second layout 

 \begin{figure}[ht]
 	\centering
 	\includegraphics[clip, trim=4cm 5cm 1cm 3cm, width=1\textwidth]{4-development/hardware/graphics/PowerLatch/PwrLatch_V3_sch.pdf}
 	\caption{Power latch schematic second version .\label{development:scematicV3}}
 \end{figure}
