...
\begin{figure}[!ht]
	\centering
	\subfigure[3D picture of Version one of the power latch \label{fig:1bitcolor}]{\includegraphics[width=0.49\linewidth]{4-development/hardware/graphics/PowerLatch/PwrLatch_V1_3d.PNG}}
	\subfigure[3D picture of Version two of the power latch \label{fig:Colorblue}]{\includegraphics[width=0.49\linewidth]{4-development/hardware/graphics/PowerLatch/PwrLatch_V2_3d.PNG}}\\
	
	\subfigure[Font mask displayed in eight bit color depth with the value for green \label{fig:Colorgreen}]{\includegraphics[width=0.49\linewidth,page=1]{4-development/hardware/graphics/PowerLatch/PwrLatch_V1_Layer.pdf}}
	\subfigure[Font mask displayed in eight bit color depth with the value for red \label{fig:Colorred}]{\includegraphics[width=0.49\linewidth,page=1]{4-development/hardware/graphics/PowerLatch/PwrLatch_V2_Layer.pdf}}
	\subfigure[Font mask displayed in eight bit color depth with the value for green \label{fig:Colorgreen}]{\includegraphics[width=0.49\linewidth,page=2]{4-development/hardware/graphics/PowerLatch/PwrLatch_V1_Layer.pdf}}
	\subfigure[Font mask displayed in eight bit color depth with the value for red \label{fig:Colorred}]{\includegraphics[width=0.49\linewidth,page=2]{4-development/hardware/graphics/PowerLatch/PwrLatch_V2_Layer.pdf}}
