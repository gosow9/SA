\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{4-development/hardware/graphics/Blockschaltbild.pdf}
	\caption{not up to date block\label{hardware:block}}
\end{figure}

\subsection{RFicient}
The Rficient demo kit comes, as previously statet with a \acs{gui}.

Is the transceiver module connected, simple steps make it possible, to set the preamble and payload data rate and the payload itself which can partly serve as an ID and transmitted data.
The power of the transmission can also be set between -30\,dBm an 10\,dBm.
the transceiver-\acs{gui} is shown in figure \ref{development:tx}.

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{4-development/hardware/graphics/TXgui.png}
	\caption{TX GUI\label{development:tx}}
\end{figure}

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{4-development/hardware/graphics/RXgui.png}
	\caption{RX GUI\label{development:rx}}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{Test environment 1 (filler)\label{development:env1}}
\end{figure}

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{4-development/hardware/graphics/env2.jpg}
	\caption{Test environment 2 (filler)\label{development:env2}}
\end{figure}
