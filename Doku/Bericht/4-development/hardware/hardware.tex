...
The display driver can be accessed from a microcontroller with a \acs{spi}-bus \cite{waveshare}.
...
Considered 
To enable and disable the power supply of everything but the ADP5090 and Wakeup receiver, the usage of a latch circuit was the most suited option.  
